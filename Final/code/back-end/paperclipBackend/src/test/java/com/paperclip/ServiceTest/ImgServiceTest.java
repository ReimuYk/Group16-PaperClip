...
public class ImgServiceTest {
    ...
    @Test
    public void testUploadAvatar() throws UnsupportedEncodingException {
        String dafaultAvatar = "data:image/jpeg;base64," +
        ...
        data.accumulate("imgStr",dafaultAvatar);
        service.uploadAvatar(data);
    }

    @Test
    public void testGetAvatar(){
        JSONObject data = new JSONObject();
        data.accumulate("username","user0");
        JSONObject a = service.getAvatar(data);
        System.out.println(a.getString("imgStr"));
    }
}
