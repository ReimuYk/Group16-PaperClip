      ...
      render() {
        return (
            ...
            <Row style={{textAlign:'left'}}>
                ...
                <Col style={{display:'inline'}}><Input addonBefore="username" style={{width:'200px'}}/></Col>
                <Col style={{display:'inline'}}><Button type="primary" style={{width:'80px'}}>Search</Button></Col>
            </Row>
